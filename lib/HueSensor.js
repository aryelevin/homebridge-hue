...
HueSensor.prototype.updatePanel = function(panelResourcePathComponents) {
  let internalThermostat = this.bridge.actionsConfigData.aqara_S1_panels['/' + panelResourcePathComponents[2] + '/' + panelResourcePathComponents[3]].ac.internal_thermostat
