...
HueSensor.prototype.updatePanel = function(panelResourcePathComponents) {
  ...
  let temperature = this.hk.targetHeaterCoolerState < 2 ? (this.hk.targetHeaterCoolerState === Characteristic.TargetHeaterCoolerState.HEAT ? this.hk.targetTemperature : this.hk.coolTemperature) : 255
