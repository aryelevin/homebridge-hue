...
const knownLights = {
  ...
  GLEDOPTO: {
    ...
    models: {
      'GL-C-008': { noWaitUpdate: true , maxCt : 500 , originalMaxCT : 495 , actualMaxCt: 370}, // Added by me: Arye Levin =  , maxCt : the range to use in HK (for the Adaptive lighting to work properly [and in sync with other lights in the house]) , originalMaxCT : the driver logical max CT , actualMaxCt: the actual light LED chip max CT
      GLEDOPTO: { // Issue #244
        fix: function () {
          if (
            this.subtype === '0a' &&
