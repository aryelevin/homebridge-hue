...
HueLight.prototype.setOn = function (on, callback) {
  ...
  // Added by me: Arye Levin
  this.updatePanels('04010055', '000000' + (newOn ? 1 : 0).toString(16).padStart(2, '0'))
  ...
  if (panelsToUpdate && Array.isArray(panelsToUpdate) && panelsToUpdate.length) {
    for (var i = panelsToUpdate.length - 1; i >= 0; i--) {
      let resourceItem = panelsToUpdate[i];
...
HueLight.prototype.setBri = function (bri, callback) {
  ...
  // Added by me: Arye Levin
  this.updatePanels('0e010055', '000000' + bri.toString(16).padStart(2, '0'))
  this.writeHKStateFile()
  // End of Added by me: Arye Levin
}
...
HueLight.prototype.setCt = function (ct, callback) {
  ...
  // Added by me: Arye Levin
  this.updatePanels('0e020055', '0000' + ct.toString(16).padStart(4, '0'))
  this.writeHKStateFile()
  // End of Added by me: Arye Levin
}
...
HueLight.prototype.setHue = function (hue, callback) {
  ...
  // Added by me: Arye Levin
  const newXy = hsvToXy(this.hk.hue, this.hk.sat, this.config.gamut)
  this.updatePanels('0e080055', Math.round(newXy[0] * 65535).toString(16).padStart(4, '0') + Math.round(newXy[1] * 65535).toString(16).padStart(4, '0'))
  this.writeHKStateFile()
  // End of Added by me: Arye Levin
}
...
HueLight.prototype.updatePanels = function(parameter, content) {
  let panelsToUpdate = this.bridge.resourcesToPanels['/' + this.type + 's/' + this.id]
  ...
  if (panelsToUpdate && Array.isArray(panelsToUpdate) && panelsToUpdate.length) {
    for (var i = panelsToUpdate.length - 1; i >= 0; i--) {
      ...
      if (pathComponents[3].startsWith('light')) {
        this.bridge.put(panelResourcePath, {aqara_s1_panel_communication: '19aa7113446d21054110' + (this.type === 'light' ? '6c69676874732f' : this.type === 'group' ? '67726f7570732f' : '') + parseInt(pathComponents[3].charAt(pathComponents[3].length-1)).toString(16).padStart(2, '0') + parameter + content}).then((obj) => {
