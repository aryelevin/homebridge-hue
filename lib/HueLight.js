...
HueLight.prototype.checkCt = function (ct) {
  ...
  if (this.config.originalMaxCT && this.config.actualMaxCt && this.config.originalMinCT && this.config.actualMinCt) {
    ...
    khCt = Math.round((((ct - this.config.originalMinCT) * (this.config.actualMaxCt - this.config.actualMinCt)) / (this.config.originalMaxCT - this.config.originalMinCT)) + this.config.actualMinCt)
  }
  // End of Added by me: Arye Levin
  if (this.hk.ct !== hkCt) {
