...
HueLight.prototype.checkOn = function (on) {
  ...
  if (this.config.wallSwitch && this.obj.state.reachable !== true) {
    ...
    hkOn = (this.config.doorlock && this.service.getCharacteristic(Characteristic.LockCurrentState).value != this.service.getCharacteristic(Characteristic.LockTargetState).value) ? this.hk.on : this.obj.state.on
  }
  if (this.hk.on !== hkOn
    // Added by me: Arye Levin
     || (this.config.doorlock && this.service.getCharacteristic(Characteristic.LockCurrentState).value != this.service.getCharacteristic(Characteristic.LockTargetState).value)
    // End of Added by me: Arye Levin
     ) {
    // End of Added by me: Arye Levin
