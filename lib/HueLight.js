...
HueLight.prototype.checkLift = function (lift) {
  ...
  if (this.hk.currentPosition !== hkPosition) {
    ...
    this.updatePanels('01010055', positionToAqaraHex[this.hk.currentPosition] + '0000', 'targetPosition')
...
HueLight.prototype._put = function () {
  ...
  // Added by me: Arye Levin
  // Used for no transition time in old FW versions of ubisys devices, needs a change in the REST API's "rest_lights.cpp" file to allow 0xFFFFF.
  // Commented since not needed for now in the newer FW versions.
  // if (this.manufacturer === 'ubisys') {
  //   desiredState.transitiontime = 65535
  // }
  // End of Added by me: Arye Levin
