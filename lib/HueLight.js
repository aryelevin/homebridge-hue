...
HueLight.prototype.checkOn = function (on) {
  ...
  if (this.config.doorLock) {
    ...
    if (this.hk.lockCurrentState !== hkLockState/*Added by me: Arye Levin*/ || this.service.getCharacteristic(Characteristic.LockCurrentState).value != this.service.getCharacteristic(Characteristic.LockTargetState).value/*End of Added by me: Arye Levin*/) {
