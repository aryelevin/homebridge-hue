...
function HueLight (accessory, id, obj, type = 'light') {
  ...
  // End of Added by me: Arye Levin
    ...
    if (this.config.ct) {
      ...
      this.service.getCharacteristic(my.Characteristics.ActiveTransitionCount)
        .updateValue(0)
      // Added by me: Arye Levin
      // this.service.addOptionalCharacteristic(Characteristic.RotationSpeed)
  ...
  try {
    ...
    if (this.config.ct) {
      ...
      //     this.service.getCharacteristic(Characteristic.RotationSpeed).updateValue(this.hk.alfactor * 100)
      //   }
      // }
    }
