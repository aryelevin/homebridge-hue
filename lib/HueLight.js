...
HueLight.prototype.checkOn = function (on) {
  ...
  if (this.hk.on !== hkOn || (this.config.doorlock && this.service.getCharacteristic(Characteristic.LockCurrentState).value != this.service.getCharacteristic(Characteristic.LockTargetState).value)) {
