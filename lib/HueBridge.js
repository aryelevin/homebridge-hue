          ...
          for (var i = devicesSerial.length - 1; i >= 0; i--) {
            ...
            if (panelData[deviceName]) {
              ...
              if (slotsRanges[deviceName]) {
                ...
                if (i <= 4) { // Lights
                  // On/Off, general type...
                  let cmd1 = '40aa7138468c0201d8024140604f7448' + slotsRanges[deviceName][0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '04010055260a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '08bfaab9d8d7b4ccac08bfaab9d8d7b4ccac08bfaab9d8d7b4'
