          ...
          for (var i = devicesSerial.length - 1; i >= 0; i--) {
            ...
            if (panelData[deviceName]) {
              ...
              if (slotsRanges[deviceName]) {
                ...
                if (i <= 4) { // Lights
                  // On/Off, general type...
                  commandsToExecute.push('40aa7138468c0201d8024140604f7448' + slotsRanges[deviceName][0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '04010055260a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '08bfaab9d8d7b4ccac08bfaab9d8d7b4ccac08bfaab9d8d7b4')
                  ...
                  // Brightness
                  commandsToExecute.push('3aaa7134448de0024131604f7448' + slotsRanges[deviceName][1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e010055170a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '0ac1c1b6c8b0d9b7d6b1c8000000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) - 1) + '0' + (deviceConfig.type === 'color' ? '2' : '4') + '00')
                  // Name
                  commandsToExecute.push('37aa7131448ee202412e604f7448' + slotsRanges[deviceName][4].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5140a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '08c9e8b1b8c3fbb3c60000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) - 1) + '0' + (deviceConfig.type === 'color' ? 'a' : 'b') + '00')
                  // Online/Offline
                  commandsToExecute.push('39aa7133448fdf024130604f7448' + slotsRanges[deviceName][5].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd160a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '0ac9e8b1b8d4dacfdfc0eb0000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) - 1) + '3' + (deviceConfig.type === 'color' ? 'c' : 'd') + '00')
                  if (deviceConfig.type === 'ct') {
                    // Color Temperature
                    commandsToExecute.push('36aa713044670a02412d604f7448' + slotsRanges[deviceName][2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e020055130a0506c9abcec2d6b5000000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) - 1) + '0300')
                  } else if (deviceConfig.type === 'color') {
                    // Color
                    commandsToExecute.push('36aa713044234a02412d604f7448' + slotsRanges[deviceName][3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e080055130a0506d1d5c9ab7879000000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) - 1) + '0100')
                  }
                } else if (i <= 7) { // curtains
                  // Opening/Closing/Stoping
                  commandsToExecute.push('38aa713244016e02412f604f651f' + slotsRanges[deviceName][0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e020055' + '150a0408b4b0c1b1d7b4ccac000000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) + 5) + '3200')
                  // Position
                  commandsToExecute.push('3caa713644fe6d024133604f651f' + slotsRanges[deviceName][1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '01010055' + '190a040000010ab4b0c1b1b4f2bfaab0d90000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) + 5) + '0c00')
                  // Online/Offline
                  commandsToExecute.push('39aa713344ff6f024130604f651f' + slotsRanges[deviceName][2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd' + '160a040ac9e8b1b8d4dacfdfc0eb0000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) + 5) + '3c00')
                  // Name
                  commandsToExecute.push('37aa713144007002412e604f651f' + slotsRanges[deviceName][3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5' + '140a0408c9e8b1b8c3fbb3c60000000000014' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) + 5) + '0a00')
                } else if (i == 8) { // AC
                  // On/Off, general type...
                  commandsToExecute.push((deviceConfig.internal_thermostat ? '38aa713244204f02412f' : '3aaa713444ef7e024131') + '6044f76a' + slotsRanges[deviceName][0].toString(16).padStart(2, '0') + panelSerial + deviceSerial + (deviceConfig.internal_thermostat ? '0e020055' : '0e200055') + (deviceConfig.internal_thermostat ? '150a0608bfd8d6c6d7b4ccac000000000000012e0000' : '1708060abfd5b5f7d1b9cbf5d7b4000000000000012e0000'))
                  // Online/Offline
                  commandsToExecute.push('39aa713344f07e0241306044f76a' + slotsRanges[deviceName][1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd' + '1608060ac9e8b1b8d4dacfdfc0eb0000000000012e6400')
                  // Name
                  commandsToExecute.push('37aa713144f17f02412e6044f76a' + slotsRanges[deviceName][2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5' + '14080608c9e8b1b8c3fbb3c60000000000012e1300')
                  // Modes
                  commandsToExecute.push('39aa713344f27c0241306044f76a' + slotsRanges[deviceName][3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa7' + '1608060ab5b1c7b0c6a5c5e4b5c40000000000012e1000')
                  // Fan Modes
                  commandsToExecute.push('39aa713344f37b0241306044f76a' + slotsRanges[deviceName][4].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa8' + '1608060ab5b1c7b0c6a5c5e4b5c40000000000012e1100')
                  // Temperatures Ranges
                  commandsToExecute.push('39aa713344f47a0241306044f76a' + slotsRanges[deviceName][5].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa9' + '1608060ab5b1c7b0c6a5c5e4b5c40000000000012e0100')
                }
