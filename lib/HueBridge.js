              ...
              if (deviceConfig) {
                ...
                if (i <= 4) { // Lights
                  ...
                  if (deviceConfig.type === 'ct') {
                    ...
                    // Color
                    commandsToExecute.push('36aa713044234a02412d604f7448' + slots[3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e080055130a0506d1d5c9ab7879000000000000015' + (parseInt(deviceSerial.charAt(deviceSerial.length-1)) - 1) + '0100')
                  }
