      ...
      for (const switches of switchesPanels) {
        ...
        if (switchesDataObject['01'] && switchesDataObject.resourcePath) {
          ...
          if (anyUpdate) {
            ...
            setTimeout(function() {
              that.log.info('Going to send: ' + JSON.stringify(dataObject) + ', to: ' + resourcePathToUse)
...
HueBridge.prototype.getAqaraIntFromHex = function(hexInput) {
  //value to change
  var a = hexInput
...
HueBridge.prototype.getAqaraHexFromInt = function(intInput) {
  //value to change
  var a = intInput
