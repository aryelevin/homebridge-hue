      ...
      for (const panel of panels) {
        ...
        for (var i = devicesSerial.length - 1; i >= 0; i--) {
          ...
          setTimeout(function() {
            ...
            that.put(panel + '/state', {aqara_s1_panel_communication: '19aa7113446d21054110' + deviceSerial + '080007fd' + '0000000' + (panelData[devicesControl[i]] ? '1' : '0')}).then((obj) => {
                      ...
                      if (deviceResourceType === 'lights/') {
                        ...
                        if (deviceConfig && slotsRanges[deviceName]) {
                          ...
                          for (var i = commandsToExecute.length - 1; i >= 0; i--) {
                            ...
                            setTimeout(function() {
                              let cmdToSend = commandsToExecute[i]
                              that.put(resource, {aqara_s1_panel_communication: cmdToSend}).then((obj) => {
