  ...
  ws
    ...
    .on('changed', (resource, obj) => {
      try {
        ...
        if (r[1] === 'sensors' && obj !== undefined && obj.buttonevent !== undefined && this.actionsConfigData && this.actionsConfigData[r[2]] && this.actionsConfigData[r[2]].length && this.state.remotesOn) {
        ...
        } else if (r[1] === 'lights' && obj !== undefined && obj['aqara_s1_panel_communication'] !== undefined && obj['aqara_s1_panel_communication'] !== lastS1PanelReports[r[2]]) {
          let updateData = obj['aqara_s1_panel_communication']
          lastS1PanelReports[r[2]] = updateData
          ...
          if (sum === 512 && commandCategory === 0x72 && commandType === 0x84 && commandAction === 0x01) {
            ...
            //   let accessoryToControl = this[deviceResourceType][deviceSerial[7]]
            //   if (accessoryToControl) {
        ...
        } else if (r[1] === 'lights' && obj !== undefined && this.panelsToResources['/' + r[1] + '/' + r[2] + '/switch'] !== undefined && obj['on'] !== undefined /*TODO: find a way to check this even if the accessory is blacklisted -> */ && a.obj.modelid === "lumi.switch.n4acn4") {
          // TODO: combine this to the above if and execute it only if the 'on' state changed (avoid using the accessory so it will work also with blacklisted accessories).
