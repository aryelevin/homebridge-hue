          ...
          for (var i = devicesSerial.length - 1; i >= 0; i--) {
            ...
            if (panelData[deviceName]) {
              ...
              if (slotsRanges[deviceName]) {
                ...
                // Brightness
                let cmd3 = '3aaa7134448de0024131604f7448' + slotsRanges[deviceName][1].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e010055170a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '0ac1c1b6c8b0d9b7d6b1c8000000000000015' + (parseInt(deviceSerial[7]) - 1) + '0' + (deviceConfig.type === 'color' ? '2' : '4') + '00'
                // Name
                let cmd4 = '37aa7131448ee202412e604f7448' + slotsRanges[deviceName][4].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '08001fa5140a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '08c9e8b1b8c3fbb3c60000000000015' + (parseInt(deviceSerial[7]) - 1) + '0' + (deviceConfig.type === 'color' ? 'a' : 'b') + '00'
                // Online/Offline
                let cmd5 = '39aa7133448fdf024130604f7448' + slotsRanges[deviceName][5].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '080007fd160a0' + (deviceConfig.type === 'dim' ? '4' : '5') + '0ac9e8b1b8d4dacfdfc0eb0000000000015' + (parseInt(deviceSerial[7]) - 1) + '3' + (deviceConfig.type === 'color' ? 'c' : 'd') + '00'
                let commandsToExecute = [cmd1, cmd2, cmd3, cmd4, cmd5]
                if (deviceConfig.type === 'ct') {
                  // Color Temperature
                  let cmd6 = '36aa713044670a02412d604f7448' + slotsRanges[deviceName][2].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e020055130a0506c9abcec2d6b5000000000000015' + (parseInt(deviceSerial[7]) - 1) + '0300'
                  commandsToExecute.push(cmd6)
                } else if (deviceConfig.type === 'color') {
                  // Color
                  let cmd6 = '36aa713044234a02412d604f7448' + slotsRanges[deviceName][3].toString(16).padStart(2, '0') + panelSerial + deviceSerial + '0e080055130a0506d1d5c9ab7879000000000000015' + (parseInt(deviceSerial[7]) - 1) + '0100'
                  commandsToExecute.push(cmd6)
                }
