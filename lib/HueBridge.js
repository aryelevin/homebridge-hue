  ...
  ws
    ...
    .on('changed', (resource, obj) => {
      try {
        ...
        // }
        if (r[1] === 'sensors' && obj !== undefined && this.actionsConfigData && this.actionsConfigData[r[2]] && this.actionsConfigData[r[2]].length && this.state.remotesOn) {
          var actionsConfig = this.actionsConfigData[r[2]];
          var sensorTypeInt = actionsConfig[0];
          this.log.info('sensor: %s, action: %s, config: %s', r[2], JSON.stringify(obj), JSON.stringify(actionsConfig));
          // Set the defaults...
          // if (!a.lastActions) {
          //   a.lastActions = {
          //     1002: 0,
