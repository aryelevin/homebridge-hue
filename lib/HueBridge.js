  ...
  if (actionsConfigData && Array.isArray(actionsConfigData) === false) {
    ...
    if (aqaraS1Panels) {
      ...
      for (const panel of panels) {
        ...
        // if (panelData.light_1 || panelData.light_2 || panelData.light_3 || panelData.light_4 || panelData.light_5) {
          
        //   if (panelData.light_1) {

        //   } else if (panelData.light_2) {
          
        //   } else if (panelData.light_3) {
            
        //   } else if (panelData.light_4) {
            
        //   } else if (panelData.light_5) {
            
        //   }
        // } else if (panelData.ac) {
          
        // } else if (panelData.curtain_1) {
          
        // } else if (panelData.curtain_2) {
          
        // } else if (panelData.curtain_3) {
      ...
      try {
        ...
        if (r[1] === 'sensors' && obj !== undefined && obj.buttonevent !== undefined && this.actionsConfigData && this.actionsConfigData[r[2]] && this.actionsConfigData[r[2]].length && this.state.remotesOn) {
          ...
          if (obj !== undefined && obj['aqara_s1_panel_communication'] !== undefined && obj['aqara_s1_panel_communication'] !== this.fullState.lights[r[2]].state.aqara_s1_panel_communication) {
            ...
            let deviceSerial = [dataArray[13], dataArray[14], dataArray[15], dataArray[16], dataArray[17], dataArray[18], dataArray[19], dataArray[20]]
            let stateParam = [dataArray[21], dataArray[22], dataArray[23], dataArray[24]]
            ...
            // State of device is reported.
            if (sum === 512) {
              if (commandCategory === 0x72 && commandType === 0x84 && commandAction === 0x01) {
              ...
              if (deviceResourceType) {
                if (deviceResourceType === 'air_cond' && stateParam[0] === 0x0e && stateParam[2] === 0x00 && stateParam[3] === 0x55 && (stateParam[1] === 0x20 || stateParam[1] === 0x02)) { // Updated Air conditioner/Heater-Cooler device state
                  ...
                  this.bridge.put(resource, {aqara_s1_panel_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '04010055' + '0000000' + onOff ? '1' : '0'}).then((obj) => {
                  ...
                  this.bridge.put(resource, {aqara_s1_panel_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e010055' + '000000' + brightness.toString(16).padStart(2, '0')}).then((obj) => {
                  ...
                  this.bridge.put(resource, {aqara_s1_panel_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e020055' + '0000' + colorTemperature.toString(16).padStart(4, '0')}).then((obj) => {
                  ...
                  const { x, y } = homebridgeLib.Colour.hsvToXy(hue, sat, accessoryToControl.config.gamut)
                  
                  this.bridge.put(resource, {aqara_s1_panel_communication: '19aa7113446d210541106c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') + '0e080055' + Math.round(newXy[0] * 65535).toString(16).padStart(4, '0') + Math.round(newXy[1] * 65535).toString(16).padStart(4, '0')}).then((obj) => {
        
                  }).catch((error) => {
                    
                  })
                } else if (stateParam[0] === 0x08 && stateParam[1] === 0x00 && stateParam[2] === 0x1f && stateParam[3] === 0xa5 && this.aqaraS1Panels['/' + r[1] + '/' + r[2]]) { // Names
                  let name = this.aqaraS1Panels['/' + r[1] + '/' + r[2]][deviceResourceType === 'lights/' ? '/light_' + deviceSerial[7] : deviceResourceType === 'curtain' ? '/curtain_' + deviceSerial[7] : 'ac'].name

                  let nameSize = name.length
                  let nameHex = toHexString(name.split ('').map (function (c) { return c.charCodeAt (0); }))

                  let totalSize = 17 + 1 + nameSize
                  ...
                  let dataToSend = '' + totalSize + 'aa71' + commandSize + '44' + counter + getUInt8(integrity).toString(16).padStart(2, '0') + '0541' + paramsSize + deviceResourceType === 'lights/' ? '6c69676874732f' + deviceSerial[7].toString(16).padStart(2, '0') : deviceResourceType === 'curtain' ? '6375727461696e' + deviceSerial[7].toString(16).padStart(2, '0') : '6169725f636f6e64' + '08001fa5' + nameSize.toString(16).padStart(2, '0') + nameHex
                  this.log.info(dataToSend)
